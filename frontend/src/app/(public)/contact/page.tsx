...
export default function ContactPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    // In production: send to your preferred email service (Resend, SendGrid, etc.)
    setStatus("success");
  }
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-3xl">
      <div className="mb-10 text-center">
        ...
        <h1 className="text-4xl font-black text-gray-900 mb-3 font-serif">Contactez-nous</h1>
        <p className="text-gray-600">Une question, un témoignage ou un partenariat ? Écrivez-nous.</p>
      </div>
